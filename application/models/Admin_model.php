...
{
    public function getLastInserted($key, $namatabel, $patient_id, $keyreference)
    {
        $query1 = $this->db->query('SELECT ' . $key . ' FROM ' . $namatabel . ' WHERE ' . $keyreference . '=' . $patient_id . ' ORDER BY ' . $key . ' LIMIT 1');
