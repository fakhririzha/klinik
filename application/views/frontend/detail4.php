                        ...
                        <div class="col-12 col-lg-10">
                            <div class="the-news-wrap">
                                <figure class="post-thumbnail">
                                    <a href="#"><img src="<?php echo base_url()?>assets/frontend/images/nanorobot.png" alt=""></a>
                                </figure>
                                ...
                                <header class="entry-header">
                                    ...
                                    <div class="post-metas d-flex flex-wrap align-items-center">
                                        ...
                                        <br>&nbsp;
                                        <p class="justify">
                                        Dunia semakin dekat dengan gambaran masa depan. Laporan dari Fast Company menunjukkan bahwa teknologi kian siap membawa manusia ke abad yang lebih berbeda. Penelitian terbaru datang dari para Ilmuwan Universitas Negeri Arizona bekerja sama dengan para peneliti dari Pusat Nasional Nanosains dan Teknologi (NCNST) Akademi Ilmu Pengetahuan Cina mengenai perkembangan teknologi di dunia medis.
                                        <br>
                                    Penelitian tersebut menunjukkan, nanorobot mampu mengecilkan tumor dengan memotong suplai darah dari tumor tersebut. Pemimpin Penelitian Hao Yan mengatakan, nanorobot dibuat dalam bentuk rancangan dan bangunan armada seperti kawanan domba yang tengah digembala. "Nanorobot kemudian akan bertugas mencari dan menghancurkan tumor kanker, sekaligus membiarkan sel sehat agar tidak terluka," ujar Yan.
                                <br>

                                Dalam sebuah siaran pers tertulis, para tim mulai mengerjakan proyek penelitian sejak lima tahun lalu. Awalnya ilmuwan tertarik untuk menggunakan nanocarier berbasis Deoxyribonucleic Acid (DNA) untuk memotong suplai darah ke tumor. Namun keahlian khusus yang dimiliki Yan mengubah konsep tersebut. Tim peneliti akhirnya menciptakan sistem robot dengan pemrograman penuh, serta bisa menyelesaikan misi secara otomatis. Teknologi terbaru dari tim peneliti dianggap sebagai terobosan mutakhir dalam pengobatan kanker.
                                <br>
                                Kemudian saat melakukan pengujian, nanorobot berhasil melawan sel kanker payudara, melanoma, ovarium, dan paru-paru pada sampel tikus. Pengujian tersebut membuat para periset yakin akan keberhasilan teknologi, dan bisa berlanjut di masa depan. Peneliti meyakini bahwa setiap pembuluh darah pembawa tumor memiliki dasar yang sama pada mamalia, meskipun uji coba dilakukan pada tikus. </p>
                                    </div>
                                </header>
