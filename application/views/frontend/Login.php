...
<body>
    ...
    ?>
				<div class="alert alert-danger"> <?php echo $this->session->flashdata('warning'); ?>
				</div><?php
} ?>
        ...
        ?>
			...
			<div class="form-style-agile">
				...
				<input placeholder="ID" name="du_id" type="text" required>
			</div>
			<div class="form-style-agile">
				<label>
					Password
				...
				<input placeholder="Password" name="du_password" type="password" required>
			</div>
			<!-- checkbox -->
			<!-- //checkbox -->
