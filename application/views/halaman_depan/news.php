                ...
                <div class="the-news">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="the-news-wrap">
                                <figure class="post-thumbnail">
                                    <a href="detail1.html"><img src="<?php echo base_url()?>assets/images/news-1.png" alt=""></a>
                                </figure>
                                ...
                                <footer class="entry-footer mt-5">
                                    <a class="button gradient-bg" href="detail1.html">Read More</a>
                                </footer>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="the-news-wrap">
                                <figure class="post-thumbnail">
                                    <a href="detail2.html"><img src="<?php echo base_url()?>assets/images/news-2.png" alt=""></a>
                                </figure>
                                ...
                                <footer class="entry-footer mt-5">
                                    <a class="button gradient-bg" href="detail2.html">Read More</a>
                                </footer>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="the-news-wrap">
                                <figure class="post-thumbnail">
                                    <a href="detail3.html"><img src="<?php echo base_url()?>assets/images/news-6.png" alt=""></a>
                                </figure>
                                ...
                                <footer class="entry-footer mt-5">
                                    <a class="button gradient-bg" href="detail3.html">Read More</a>
                                </footer>
                            </div>
                        </div>
