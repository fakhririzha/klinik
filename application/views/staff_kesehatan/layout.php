            ...
            <ul class="collapsible" data-collapsible="accordion">
              ...
              <li class="bold">
                <a class="collapsible-header waves-effect">
                  ...
                  <span class="nav-text">Pemeriksaan Kesehatan</span>
                </a>
                <div class="collapsible-body">
                  <ul>
                    <li>
                      <a href="<?= site_url('admin/data_pasien') ?>"><i
                          class="material-icons">assignment</i>Form Pemeriksaan</a></li>
                    <li>
                      <a href="<?= site_url('admin/registrasi_pasien') ?>"><i
                          class="material-icons">group_add</i>List Pemeriksaan</a></li>
                  </ul>
                </div>
              </li>
              <li class="bold">
                  ...
                  <ul>
                    <li>
                      <a href="<?= site_url('admin/e_payment') ?>"><i
                          class="material-icons">list</i>Form Rekam Medis</a></li>
                    <li>
                      <a href="<?= site_url('admin/aktivasi_e_payment') ?>"><i
                          class="material-icons">beenhere</i>Histori Medis</a></li>
                  </ul>
                </div>
              </li>
              <li class="bold">
                <a class="collapsible-header waves-effect">
                  ...
                  <span class="nav-text">Form Kesimpulan</span>
                </a>
                <div class="collapsible-body">
                  <ul>
                    <li>
                      <a href="<?= site_url('admin/data_obat') ?>"><i
                          class="material-icons">bubble_chart</i>Metode Penyembuhan</a></li>
                    <li>
                      <a href="<?= site_url('admin/tambah_obat') ?>"><i
                          class="material-icons">add_box</i>Metode Pengobatan</a></li>
                  </ul>
                </div>
              </li>
              <li class="bold">
