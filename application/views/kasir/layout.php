                  ...
                  <ul>
                    <li>
                      <a href="<?= site_url('admin/data_pasien') ?>"><i
                          class="material-icons">attach_money</i>Tunai</a></li>
                    <li>
                      <a href="<?= site_url('admin/registrasi_pasien') ?>"><i
                          class="material-icons">monetization_on</i>E-Payment</a></li>
                  </ul>
                </div>
              </li>
              <li class="bold">
                  ...
                  <ul>
                    <li>
                      <a href="<?= site_url('admin/aktivasi_e_payment') ?>"><i
                          class="material-icons">lock_open</i>Aktivasi E-Payment</a></li>
                    <li>
                      <a href="<?= site_url('admin/proses_transaksi') ?>"><i
                          class="material-icons">arrow_upward</i>Top-Up</a></li>
                  </ul>
                </div>
              </li>
            </ul>
